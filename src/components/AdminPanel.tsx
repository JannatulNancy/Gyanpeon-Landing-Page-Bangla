...
export default function AdminPanel() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900 p-4 font-sans selection:bg-[#6C4CF5] selection:text-white">
        <div className="w-full max-w-md bg-white rounded-[24px] border border-slate-100 shadow-2xl overflow-hidden p-8 relative animate-scale-up animate-fade-in">
          <div className="flex flex-col items-center text-center space-y-4 mb-6">
            ...
            <div>
              <h3 className="font-serif font-bold text-2xl text-slate-900">GyanPeon Admin Portal</h3>
              <p className="text-xs text-slate-500 max-w-xs mt-1">
                This control panel is strictly for platform administrators only.
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleVerifyPin} className="space-y-4">
            ...
            <div className="pt-2 flex gap-3">
              <a
                ...
                className="flex-1 py-3 border border-slate-200 hover:bg-slate-50 rounded-xl text-slate-600 font-bold text-center text-xs transition-colors"
              >
                Go to Website
              </a>
              <button
  ...
  return (
    <div className="fixed inset-0 z-50 flex bg-slate-50 overflow-hidden font-sans">
      ...
      <div className="w-full bg-white h-screen flex flex-col overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#6C4CF5] to-[#8B5CF6] text-white px-8 py-5 flex items-center justify-between border-b border-slate-100 shadow-sm shrink-0">
          <div className="flex items-center gap-3.5">
            <Settings className="w-6 h-6 animate-spin-slow" />
            <div>
              <h2 className="font-serif text-2xl font-bold tracking-tight">GyanPeon Marketing Admin Panel</h2>
              <p className="text-xs text-white/80 font-sans mt-0.5">Configure landing content, active admission campaigns, packages, and settings</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            <a 
              ...
              className="px-4 py-2 bg-white/15 hover:bg-white/25 text-white rounded-xl font-bold text-xs transition-all duration-200 border border-white/15 cursor-pointer"
            >
              View Live Site
            </a>
            <button 
              onClick={() => {
                ...
                sessionStorage.removeItem('gyanpeon_admin_auth');
              }}
              className="px-4 py-2 bg-rose-500/20 hover:bg-rose-500/35 text-rose-100 rounded-xl font-bold text-xs transition-all duration-200 cursor-pointer"
            >
              Log Out
            </button>
          </div>
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-56 bg-slate-50 border-r border-slate-100 p-3 flex flex-col gap-1 text-sm font-sans shrink-0">
            <button
        ...
        <div className="bg-slate-50 border-t border-slate-100 px-8 py-4 flex gap-3 justify-end items-center shrink-0">
          <span className="text-[11px] text-slate-400 font-medium font-sans">All changes take effect immediately on the live website.</span>
          <a
            href="/"
            onClick={(e) => {
              e.preventDefault();
            ...
            className="px-6 py-2.5 rounded-xl bg-[#6C4CF5] hover:bg-[#5b3ee0] text-white text-xs font-bold transition-all flex items-center gap-1.5 shadow-md shadow-[#6C4CF5]/10 cursor-pointer"
          >
